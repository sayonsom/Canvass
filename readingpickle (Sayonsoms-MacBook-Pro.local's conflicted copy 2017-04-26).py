...
def getInfo(data1, *args, **kwargs):
    ...
    try:
        ...
        print "No extra argument passed"
...
def changeLoadServiceStatus(data1,loadInfo,choice):
    ...
    if modifyFile == "1":
        ...
        pickle.dump(data1, open("case14.p", "wb"))
        y = open( "case14.p", "rb" )
        data1 = pickle.load(y)
...
#getInfo(data1)
#pprint.pprint(data1)
#pickle.dump(data1, open("case14mod.p", "wb"))



#case14 = pp.from_pickle("case14.p")
#net = pn.case14()
...
if __name__ == '__main__':
    ...
    filename = "".join([arguments['<model>'],".p"])
